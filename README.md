...
- **Compatibility is a goal, not a guarantee.** On stratified public GIAB HG002 samples, all five compared gene-annotation fields agree with the fixed ANNOVAR baseline for 98.311% of hg19 alleles and 98.346% of hg38 alleles after allowing only list-order changes; more than 1,000 substantive disagreements remain on each assembly. Independent VCF conversion also differs for many indels. See the [public-data concordance report](docs/ACCURACY_GIAB_2026-09-19.md) for methods, denominators, examples, and limitations. Complex indels, complete HGVS notation, ncRNA classification, transcript ordering, and specialized database protocols remain incomplete.
